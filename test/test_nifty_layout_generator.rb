...
class TestPizzaLayoutGenerator < Test::Unit::TestCase
  ...
  context "generator with haml option" do
    rails_generator :pizza_layout, "foobar", :haml => true
