...
class TestPizzaScaffoldGenerator < Test::Unit::TestCase
  ...
  context "routed" do
    ...
    context "generator without name" do
      should "raise usage error" do
        assert_raise Rails::Generator::UsageError do
          run_rails_generator :pizza_scaffold
        end
      end
    end
  
    context "generator with no options and no existing model" do
      rails_generator :pizza_scaffold, "LineItem"
    ...
    context "generator with some attributes" do
      rails_generator :pizza_scaffold, "line_item", "name:string", "description:text"
    ...
    context "generator with index action" do
      rails_generator :pizza_scaffold, "line_item", "index"
    ...
    context "generator with show action" do
      rails_generator :pizza_scaffold, "line_item", "show"
    ...
    context "generator with new and create actions" do
      rails_generator :pizza_scaffold, "line_item", "new", "create"
    ...
    context "generator with edit and update actions" do
      rails_generator :pizza_scaffold, "line_item", "edit", "update"
    ...
    context "generator with edit and update actions" do
      rails_generator :pizza_scaffold, "line_item", "destroy"
    ...
    context "generator with new and edit actions" do
      rails_generator :pizza_scaffold, "line_item", "new", "edit"
    ...
    context "generator with attributes and actions" do
      rails_generator :pizza_scaffold, "line_item", "name:string", "new", "price:float", "index", "available:boolean"
    ...
    context "generator with show, create, and update actions" do
      rails_generator :pizza_scaffold, "line_item", "show", "create", "update"
    ...
    context "generator with attributes and skip model option" do
      rails_generator :pizza_scaffold, "line_item", "foo:string", :skip_model => true
    ...
    context "generator with no attributes" do
      rails_generator :pizza_scaffold, "line_item"
    ...
    context "generator with exclemation mark and show, new, and edit actions" do
      rails_generator :pizza_scaffold, "line_item", "!", "show", "new", "edit"
    ...
    context "generator with --skip-controller" do
      rails_generator :pizza_scaffold, "line_item", :skip_controller => true
    ...
    context "generator with --skip-migration" do
      rails_generator :pizza_scaffold, "line_item", "name:string", :skip_migration => true
    ...
    context "generator with --skip-timestamps" do
      rails_generator :pizza_scaffold, "line_item", "name:string", :skip_timestamps => true
    ...
    context "existing model" do
      ...
      context "generator with skip model option" do
        rails_generator :pizza_scaffold, "recipe", :skip_model => true
      ...
      context "generator with attribute specified" do
        rails_generator :pizza_scaffold, "recipe", "zippo:string"
    ...
    context "with spec dir" do
      ...
      context "generator with new and index actions" do
        rails_generator :pizza_scaffold, "line_item", "new", "index"
      ...
      context "generator with edit and index actions" do
        rails_generator :pizza_scaffold, "line_item", "edit", "index"
      ...
      context "generator with testunit specified" do
        rails_generator :pizza_scaffold, "line_item", "name:string", :test_framework => :testunit
    ...
    context "with test dir" do
      ...
      context "generator with rspec specified" do
        rails_generator :pizza_scaffold, "line_item", "name:string", :test_framework => :rspec
        
        should_generate_file "spec/models/line_item_spec.rb"
      end
      
      context "generator with shoulda specified" do
        rails_generator :pizza_scaffold, "line_item", "name:string", :test_framework => :shoulda
    ...
    context "generator with haml option" do
      rails_generator :pizza_scaffold, "LineItem", :haml => true
