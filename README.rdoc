...
* Haml is default for pizza_scaffold, use --erb to switch back to erb
...
* Validations for models automaticly entered

==== Todo

* AuthLogic (from http://github.com/binarylogic/authlogic)
...
http://github.com/iain/pizza-generators/
